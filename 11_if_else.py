...
# Yuqoridagi misolda, kimdur ahror@yandex.ru manzilini band qilgan, agarda men 'Ahror', yoki 'AHror', yoki 'AHROR' deb login tanlasam ham, ahror@yandex.ru band bo'gani sababli men so'ragan loginlar rad qilinaveradi. 
...
#     print("Kirish mumkin emas!\n", 18-(2025-yil), "yildan keyin mumkin!")
# else:
#     print("Xush kelibsiz!")
...
# yosh = int(input("Yoshingiz nechida?>>>"))
# if yosh>65: print("Sizda COVID-19 yuqtirish xavfi yuqori ekan")
